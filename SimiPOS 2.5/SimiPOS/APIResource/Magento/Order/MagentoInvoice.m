...
- (void)addSignature:(Invoice *)invoice withSign:(NSData *)image finished:(SEL)finishedMethod
{
    ...
    NSString *myString = [NSString stringWithFormat:@"%@",[image base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength]];
    [params setValue:myString forKey:@"signature"];
