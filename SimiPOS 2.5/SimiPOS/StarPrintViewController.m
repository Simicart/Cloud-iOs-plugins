...
//    UIFont *largeSystemFont = [UIFont fontWithName:@"Avenir Next Condensed Demi Bold" size:26];
    ...
    UIFont *smallSystemFont = [UIFont fontWithName:@"Courier" size:14];
    ...
    if (cell == nil) {
        ...
        UILabel *footer = [storeAddress clone];
    ...
    if ([indexPath section] == 4) {
        ...
        ((UILabel *)[cell viewWithTag:7]).text = [NSString stringWithFormat:@"%@  %@", text, [MSDateTime formatDateTime:[self.order objectForKey:@"created_at"]]];
