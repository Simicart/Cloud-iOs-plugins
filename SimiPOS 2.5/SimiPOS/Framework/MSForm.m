...
// lionel add fix bug ui
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    // add borom line view for cell
    if (self.addBottomLineView) {
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(5, cell.frame.size.height - 1, cell.frame.size.width - 10, 1)];
