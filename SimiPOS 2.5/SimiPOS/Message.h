...
#define MESSAGE_CONNECTOR_ERROR @"Your server cannot be connected. Please make sure that you've installed the connector on your site. If it is already installed, please check the access permission again. (View more detailed instructions here: https://www.magestore.com/productfile/index/view/fileid/311/)"
