        ...
        if(success && [result objectForKey:@"data"]){
            ...
            dispatch_async(backgroundQueue, ^{
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    NSString * defaultCashAmount =[[result objectForKey:@"data"] objectForKey:@"default_opening_cash"];
...
-(void)checkAndCloseStore{
    ...
    if(cashInfoCell.manualCountTextField.text.length==0){
        ...
        [[APIManager shareInstance] closeStoreManualCount:cashInfoCell.manualCountTextField.text CashAmountKept:self.cashAmountInputTextField.text Callback:^(BOOL success, id result) {
            ...
            if(success){
                ...
                dispatch_async(backgroundQueue, ^{
                    dispatch_async(dispatch_get_main_queue(), ^{
                        //[Utilities alert:@"Message" withMessage:@"Close Store send success!"];
