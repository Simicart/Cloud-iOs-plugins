...
- (void)viewDidLoad
{
    ...
    NSString *paymentMethod = [MSValidator isEmptyString:[self.order objectForKey:@"payment_method"]] ? @"" :[self.order objectForKey:@"payment_method"];
    ...
    NSString *totalPaid = [MSValidator isEmptyString:[self.order objectForKey:@"total_paid"]] ? @"0" : [self.order objectForKey:@"total_paid"];
    NSString *totalRefunded = [MSValidator isEmptyString:[self.order objectForKey:@"total_refunded"]] ? @"0" : [self.order objectForKey:@"total_refunded"];
    NSString *totalCanceled = [MSValidator isEmptyString:[self.order objectForKey:@"total_canceled"]] ? @"0" : [self.order objectForKey:@"total_canceled"];
    
    amountTotal = [totalPaid doubleValue] - [totalRefunded doubleValue] - [totalCanceled doubleValue];
