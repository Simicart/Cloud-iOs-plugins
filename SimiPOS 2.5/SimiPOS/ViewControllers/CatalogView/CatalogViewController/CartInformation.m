...
- (UITableViewCell *)productViewCell:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        if(WINDOW_WIDTH > 1024){
            errorMark = [[UIView alloc] initWithFrame:CGRectMake(0, 0, WINDOW_WIDTH -801, 80)];
        }else{
            errorMark = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 427, 80)];
        }
        // End
