...
- (NSString *)tableView:(UITableView *)tablerView titleForHeaderInSection:(NSInteger)section
{
    return nil;
}
...
- (UIButton *)doneEditButton
{
    if (self.doneButtonView == nil) {
        ...
        self.doneButtonView.frame = CGRectMake(0, [self.masterOptions count] * 64 + 10, 280, 44);
