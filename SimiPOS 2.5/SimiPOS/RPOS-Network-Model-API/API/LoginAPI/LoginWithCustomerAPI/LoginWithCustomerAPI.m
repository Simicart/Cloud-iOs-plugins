...
@implementation LoginWithCustomerAPI
...
- (void)loginCustomerWithParams:(NSDictionary *)params method:(NSString*)method target:(id)target selector:(SEL)selector{
    ...
    [self requestWithMethod:method URL:url params:params target:target selector:selector header:headerParams];
}
