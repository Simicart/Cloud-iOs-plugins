...
@implementation ShippingAddressAPI

- (void)getShippingAddressWithParams:(NSDictionary *)params method:(NSString*)method target:(id)target selector:(SEL)selector{
