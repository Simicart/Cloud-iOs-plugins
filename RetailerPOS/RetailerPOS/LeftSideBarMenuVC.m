...
-(void)initDefault{
    ...
    NSArray *tempTitleArr = [[NSArray alloc] initWithObjects:@"Account",@"Products", nil];
    ...
    if(permission.manage_order.boolValue || permission.manage_order_refund.boolValue){
        ...
        tempTitleArr = [tempTitleArr arrayByAddingObject:@"Orders"];
        tempImgArr = [tempImgArr arrayByAddingObject:@"menu_order"];
    }
    tempKeyArray = [tempKeyArray arrayByAddingObject:@"orders_onhold"];
    tempTitleArr = [tempTitleArr arrayByAddingObject:@"On Hold Order"];
    ...
    if(permission.manage_cash_drawer.boolValue){
        ...
        tempTitleArr = [tempTitleArr arrayByAddingObject:@"Cash Drawer"];
    ...
    if(permission.all_reports.boolValue || permission.x_report.boolValue|| permission.z_report.boolValue|| permission.eod_report.boolValue){
        ...
        tempTitleArr = [tempTitleArr arrayByAddingObject:@"Reports"];
    ...
    tempTitleArr = [tempTitleArr arrayByAddingObject:@"Customers"];
    tempTitleArr = [tempTitleArr arrayByAddingObject:@"Settings"];
    ...
    //Synchronization
    tempImgArr = [tempImgArr arrayByAddingObject:@"menu_synchronize"];
    tempTitleArr = [tempTitleArr arrayByAddingObject:@"Synchronization"];
    tempKeyArray = [tempKeyArray arrayByAddingObject:@"synchronization"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([menuKey isEqualToString:@"account"]) {
        ...
        viewController = [[OrderOfflineListViewController alloc] initWithNibName:@"OrderOfflineListViewController" bundle:nil]; //[OrdersViewController sharedInstance];
        ...
        viewController =[[SynchronizationVC alloc] initWithNibName:@"SynchronizationVC" bundle:nil];
    }
