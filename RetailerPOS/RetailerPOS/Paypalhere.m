...
- (void)openPaypalHereApp:(CheckoutViewController *)checkoutVC
{
    ...
    NSString *encodedReturnUrl = [@"RetailerPOS://takePayment?{result}?Type={Type}&InvoiceId={InvoiceId}&Tip={Tip}&Email={Email}&TxId={TxId}" stringByAddingPercentEscapesUsingEncoding:NSASCIIStringEncoding];
