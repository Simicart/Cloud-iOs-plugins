...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        */
        ...
        CGSize maximumLabelSize = CGSizeMake(labelMaxWidth, 9999); // this width will be as per your requirement
        
        CGSize titleSize = [self.titleLabel sizeThatFits:maximumLabelSize];
        ...
        */
        ...
        CGSize subtitleSize = [self.subtitleLabel sizeThatFits:maximumLabelSize];
