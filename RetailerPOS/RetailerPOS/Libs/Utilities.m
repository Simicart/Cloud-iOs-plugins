...
//****** Khởi tạo hiện thị & ẩn Indicator khi load dữ liệu
#pragma mark - Hiển thị Indicator
+(void)showIndicator:(UIView *)parrentView setCenter:(CGPoint)center{
    
    loadView  =[[LoadingView alloc] init];
    [loadView setCenter:center];
    [parrentView addSubview:loadView];
