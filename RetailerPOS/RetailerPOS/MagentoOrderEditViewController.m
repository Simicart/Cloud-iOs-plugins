...
//  RetailerPOS
//
//  Created by Nguyen Duc Chien on 4/24/14.
...
- (void)reloadData
{
    ...
    self.itemView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 596, 1)];
...
- (void)showOrderItemsDetail
{
    ...
    for (NSUInteger j = 0; j < [orderInfo count]; j++) {
        ...
        UILabel *headerLabel = [[UILabel alloc] initWithFrame:CGRectMake(-1, height-1, 300, 30)];
        ...
        headerLabel.frame = CGRectMake(298, height-1, 300, 30);
        ...
        height += 29;
        // Order Info Detail
        UIView *detailView = [[UIView alloc] initWithFrame:CGRectMake(-1, height, 598, 9)];
        ...
        UITextView *detailText = [[UITextView alloc] initWithFrame:CGRectMake(9, 1, 288, 9)];
       ...
       // detailText.frame = CGRectMake(9, 1, 288, detailTextHeight);
        ...
        detailText.frame = CGRectMake(307, 1, 288, detailTextHeight);
        
        detailView.frame = CGRectMake(-1, height-1, 598, detailTextHeight + 2);
    ...
    self.itemView.frame = CGRectMake(0, 1, 596, height);
}
...
- (void)drawItemHeader:(UIView *)page height:(CGFloat *)height
{
    ...
    UIView *header = [[UIView alloc] initWithFrame:CGRectMake(-1, *height-1, 598, 24)];
    ...
    *height += 27;
    ...
    // Each Label
    CGFloat start = 24;
    UILabel *headerLabel = [[UILabel alloc] initWithFrame:CGRectMake(start, 2, 262, 20)];
...
{
    UIView *itemView = [[UIView alloc] initWithFrame:CGRectMake(7, *height, 598, 16)];
    ...
    if ([productName objectForKey:@"name"]) {
        delta = 0;
        UITextView *name = [[UITextView alloc] initWithFrame:CGRectMake(x, y, 286, 30)];
    ...
    if ([productName objectForKey:@"options"]) {
        ...
        for (NSDictionary *option in options) {
            ...
            if ([option objectForKey:@"title"]) {
                UITextView *title = [[UITextView alloc] initWithFrame:CGRectMake(0, y-7, 274, 9)];
            ...
            if ([option objectForKey:@"value"]) {
                UITextView *value = [[UITextView alloc] initWithFrame:CGRectMake(x, y-7, 262, 9)];
    ...
    content.frame = CGRectMake(x, delta, 99, 9);
...
- (void)showOrderComments
{
    ...
    UIView *header = [[UIView alloc] initWithFrame:CGRectMake(-1, height, 598, 24)];
    [header setBackgroundColor:[UIColor backgroundColor]];
    [header.layer setBorderColor:[UIColor lightBorderColor].CGColor];
    [header.layer setBorderWidth:1.0];
    ...
    self.commentView.frame = CGRectMake(0, 1, 596, height);
}
