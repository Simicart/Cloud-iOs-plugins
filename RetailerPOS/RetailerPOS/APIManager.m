...
-(void)getCustomer:(NSString *)searchKey Callback:(Callback)callback
{
    ...
    [params setValue:@[searchKey, [NSNumber numberWithUnsignedInteger:1], [NSNumber numberWithUnsignedInteger:9999]] forKey:@"params"];
    [self post:params callback:callback withUrlAPI:nil];
}
...
-(void)getOrderPrintLink:(NSString *)incrementId Callback:(Callback)callback{
    ...
    [params setObject:incrementId forKey:@"params"];
    [self post:params callback:callback withUrlAPI:nil];
}
...
-(void)getListProducts:(Callback)callback{
    ...
    NSMutableDictionary * params =[[NSMutableDictionary alloc] initWithObjectsAndKeys:@"product.list",@"method", nil];
    NSMutableDictionary * conditions =[[NSMutableDictionary alloc] init];
    
    NSMutableArray *functionParams = [[NSMutableArray alloc] initWithObjects:conditions, [NSNumber numberWithUnsignedInteger: curPage], [NSNumber numberWithUnsignedInteger: pageSize], nil];
...
-(void)getListCategories:(Callback)callback{
    ...
    NSMutableDictionary * params =[[NSMutableDictionary alloc] initWithObjectsAndKeys:@"category.tree",@"method", nil];
    [self post:params callback:callback withUrlAPI:nil];
}

-(void)getListPayments:(Callback)callback{
    
    NSMutableDictionary * params =[[NSMutableDictionary alloc] initWithObjectsAndKeys:@"checkout_payment.offlinelist",@"method", nil];
    [self post:params callback:callback withUrlAPI:nil];
}
@end
